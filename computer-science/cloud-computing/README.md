...
클라우드 컴퓨팅은 인터넷을 통해 서버, 스토리지(저장소), 데이터베이스, 소프트웨어 등의 컴퓨팅 자원들을 필요할 때마다(on demand) 빌려 쓰고 쓴 만큼 비용을 지불하는 기술이다. **클라우드 컴퓨팅 기술이 없다면 개인은 모든 데이터를 개인 컴퓨터나 USB에 저장해야 하며, 기업은 회사 내부의 물리적 서버를 직접 구축하고 관리해야 한다.**
